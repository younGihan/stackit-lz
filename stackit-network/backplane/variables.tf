...
variable "bbd_repository_url" {
  type        = string
  nullable    = false
  description = "Git URL of the repository containing the stackit-network building block implementation (this repo, once pushed to your git hosting)."
}

variable "bbd_repository_path" {
  type        = string
  default     = "stackit-network/buildingblock"
  nullable    = false
  description = "Path within bbd_repository_url to the stackit-network module."
}
